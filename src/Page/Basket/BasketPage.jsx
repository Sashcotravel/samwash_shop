                ...
                <div className={s.div4}>
                    <div>
                        ...
                        {!isValidSet && <div className={s.div4_block3}>
                            ...
                            <Link className={s.loginBut} to='/login'>авторизуватися</Link>
                            <p className={s.orP}>Або</p>
                            <Link className={s.registerBut} to='/register'>зареєструватися</Link>
                            <div className={s.divWithout}>
                                <p className={s.p_div4}><b>Бажаєте зробити покупку без реєстрації?</b></p>
                                <Link className={s.registerBut2} to='#' onClick={() => setOpen(true)}>Заповніть форму
                                    доставки</Link>
                            </div>
                        </div>}
