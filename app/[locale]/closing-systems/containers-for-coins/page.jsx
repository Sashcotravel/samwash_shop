...
function MixriteDispenser() {
    ...
    return (
        <div className={s.mainDiv}>
            ...
            <NavProduct2 back={'/closing-systems'}/>
                    ...
                    <div className={s.breadcrumbs}>
                        <div className={s.crumbs}>
                            <ul>
                                ...
                                <li>
                                    <Link href='/closing-systems'> Системи закриття</Link>
                                </li>
                                <li>
                                    <span> Грошові ящики, сейфи та контейнери для монет</span>
                                </li>
                            </ul>
                        </div>
                    </div>

                    <h1>Грошові ящики, сейфи та контейнери для монет</h1>
