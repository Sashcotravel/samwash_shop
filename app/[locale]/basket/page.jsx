...
function Page() {
    ...
    return (
        <div className={s.main}>
            ...
            {order.length === 0 ? <h2 className={s.dontHaveOrder}>Ваш кошик порожній</h2>
                : <>
                        ...
                        {isValidSet && <div className={s.div_pay}>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div className={s.div_input_address}>
                                            {
                                                radio === 1 ? <>
                                                        ...
                                                        {change && <input type='email' value={user.name} placeholder="ім'я"
                                                                          id='name10'
                                                    ...
                                                    : <>
                                                        ...
                                                        {change && <input type='text' value={user.company}
                                                                          placeholder="ім'я компанії" id='company10'
                                                                          onChange={e => setUser(prev => {
                                            ...
                                            {!change &&
                                                <p style={{margin: '5px 0'}}>{user.street} {user.numBud}/{user.numFlat}</p>}
                                            {change && <input type='text' value={user.street} placeholder='вулиця'
                                                              id='street10'
                                                              onChange={e => setUser(prev => {
                                                                  return {...prev, street: e.target.value}
                                                              })}/>}
                                            {change &&
                                                <input type='text' value={user.numBud} placeholder='номер будинку'
                                                       onChange={e => setUser(prev => {
                                                           return {...prev, numBud: e.target.value}
                                                       })}/>}
                                            {change &&
                                                <input type='text' value={user.numFlat} placeholder='номер квартири'
                                                       onChange={e => setUser(prev => {
                                                           return {...prev, numFlat: e.target.value}
                                                       })}/>}
                                            {!change && <p style={{margin: '5px 0'}}>{user.city}</p>}
                                            {change &&
                                                <input type='text' value={user.city} placeholder='місто' id='city10'
                                                       onChange={e => setUser(prev => {
                                                           return {...prev, city: e.target.value}
                                                       })}/>}
                                            {!change && <p style={{margin: '5px 0'}}>{user.country}</p>}
                                            {change && <input type='text' value={user.country} placeholder='країна'
                                                              id='country10'
                                                              onChange={e => setUser(prev => {
                                        ...
                                        <div className={s.divMail} style={change ? {width: '100%'} : undefined}>
                                            ...
                                            {change &&
                                                <input type='text' value={user.email} placeholder='пошта' id='email10'
                                                       onChange={e => setUser(prev => {
                                                           return {...prev, email: e.target.value}
                                                       })}/>}
                                        </div>
                                        <div className={s.divPhone}
                                             style={change ? {float: 'left', width: '100%'} : undefined}>
                                            {!change && <img src='/header/headphone.png' alt='phone'/>}
                                            {!change && <span>{user.phone}</span>}
                                            {change &&
                                                <input type='text' value={user.phone} placeholder='телефон' id='phone10'
                                                       onChange={e => setUser(prev => {
                            ...
                            <div className={s.div_pay_one}>
                                <label className={s.label_radio2} onClick={() => setRadio3(1)}>
                                    ...
                                    <span
                                        className={`${s.realRadio} ${radio3 === 1 ? s.realRadio2 : undefined}`}></span>
                                    <span><b>розписка</b></span>
                                </label>
                                <label className={s.label_radio2} onClick={() => setRadio3(2)}>
                                    <input type='radio' name='name' className={s.inputHidden}/>
                                    <span
                                        className={`${s.realRadio} ${radio3 === 2 ? s.realRadio2 : undefined}`}></span>
                                    ...
                                    {radio3 === 2 && <div className={s.factura}>
...

                                        {
                                            radio === 1 ? <>
                                                    ...
                                                    {change2 && <input type='email' value={user3.name} placeholder="ім'я"
                                                                       id='name11'
                                                ...
                                                : <>
                                                    ...
                                                    {change2 &&
                                                        <input type='text' value={user3.company} placeholder="ім'я компанії"
                                                               id='company11'
                                                               onChange={e => setUser3(prev => {
                                                                   return {...prev, company: e.target.value}
                                                               })}/>}
                                        ...
                                        {!change2 &&
                                            <p style={{margin: '5px 0'}}>{user3.street} {user.numBud}/{user.numFlat}</p>}
                                        {change2 &&
                                            <input type='text' value={user3.street} placeholder='вулиця' id='street11'
                                                   onChange={e => setUser3(prev => {
                                                       return {...prev, street: e.target.value}
                                                   })}/>}
                                        ...
                                        {change2 &&
                                            <input type='text' value={user3.numFlat} placeholder='номер квартири'
                                                   onChange={e => setUser3(prev => {
                                                       return {...prev, numFlat: e.target.value}
                                                   })}/>}
                                        {!change2 && <p style={{margin: '5px 0'}}>{user3.city}</p>}
                                        {change2 &&
                                            <input type='text' value={user3.city} placeholder='місто' id='city11'
                                                   onChange={e => setUser3(prev => {
                                                       return {...prev, city: e.target.value}
                                                   })}/>}
                                        {!change2 && <p style={{margin: '5px 0'}}>{user3.country}</p>}
                                        {change2 &&
                                            <input type='text' value={user3.country} placeholder='країна' id='country11'
                                                   onChange={e => setUser3(prev => {
                                                       return {...prev, country: e.target.value}
                                                   })}/>}
                                    </div>}
                    ...
                    <div className={s.div4}>
                        <div>
                            ...
                            {!isValidSet && <div className={s.div4_block3}>
                                ...
                                <p className={s.p2_div4}><b>увійдіть або створіть новий обліковий запис у магазині.</b>
                                </p>
                                ...
                                <div className={s.divWithout}>
                                    ...
                                    <Link className={s.registerBut2} href='#' onClick={() => setOpen(true)}>Заповніть
                                        форму
                                        доставки</Link>
                                </div>
                            </div>}
