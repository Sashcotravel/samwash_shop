...
function MixriteDispenser() {
    ...
    return (
        <div className={s.mainDiv}>
            ...
            <NavProduct2 back={'/water-purification/softener'}/>
                    ...
                    <div className={s.breadcrumbs}>
                        <div className={s.crumbs}>
                            <ul>
                                ...
                                <li>
                                    <Link href='/water-purification/softener'> Пляшки з пом'якшувачем і аксесуари</Link>
                                </li>
                                <li>
                                    <span> Фільтруючий шар</span>
                                </li>
                            </ul>
                        </div>
                    </div>

                    <h1>Фільтруючий шар</h1>
