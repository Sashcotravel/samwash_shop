...
function MixriteDispenser() {
    ...
    return (
        <div className={s.mainDiv}>
            ...
            <NavProduct2 back={'/equipment-washing-station/door-stickers'}/>
                    ...
                    <div className={s.breadcrumbs}>
                        <div className={s.crumbs}>
                            <ul>
                                ...
                                <li>
                                    <Link href='/equipment-washing-station'> Елементи та обладнання мийної станції</Link>
                                </li>
                                <li>
                                    <Link href='/equipment-washing-station/door-stickers'> Наклейки на двері</Link>
                                </li>
                                <li>
